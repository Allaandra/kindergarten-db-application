...
const HIDDEN_FIELDS = [
    ...
    'max_capacity', 
    'group_id',
    // Тимчасово ховаємо батьків у таблиці ДІТЕЙ, щоб не дублювати інфу, поки не налаштуємо зв'язки
    'parent_name',
    'parent_phone'
];
...
const AdminList = ({ user, type }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    // Люди (Співробітники/Родичі/Діти)
  ...
  if (type === 'groups') {
    ...
    pageTitle = 'Батьки (Родичі)'; addButtonText = 'Додати родича'; apiEndpoint = '/api/relatives';
  }
  ...
  const handleEdit = (row) => {
    ...
    // Заповнюємо форму залежно від типу сторінки
    if (type === 'groups') {
        setFormData({
              ...
              {type === 'employees' && (
                <>
                  ...
                  <div className="form-group" style={{background: '#e8f6f3', padding: '10px', borderRadius: '10px'}}>
                    <label className="form-label">🔗 Системний логін</label>
                  ...
                  <div className="form-group" style={{background: '#e8f6f3', padding: '10px', borderRadius: '10px', marginTop: '10px'}}>
                    ...
                    <input type="password" name="password" placeholder={editingId ? "Залиште пустим" : ""} required={!editingId} value={formData.password || ''} onChange={handleInputChange} />
                  </div>
                </>
              )}

              {/* === ФОРМА РОДИТЕЛЕЙ (ТЕПЕР ЯК У СПІВРОБІТНИКІВ) === */}
              {type === 'relatives' && (
                <>
                  <div style={{display: 'flex', gap: '10px'}}>
                      <div className="form-group" style={{flex: 1}}>
                  ...
                  <div className="form-group" style={{background: '#e8f6f3', padding: '10px', borderRadius: '10px', marginTop: '10px'}}>
                    ...
                    <input 
                        ...
                        required={!editingId} // Обов'язковий при створенні
